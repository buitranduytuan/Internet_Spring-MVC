...
<div class="container MyForm" >
  <form:form action = "${contextPath}/dichVu/add-action" method = "post" onsubmit="return validateFormTaoDV()"
  modelAttribute="dichVu">
    ...
    <div class="form-group">
		...
		<form:input path="maDV" id = "maDV" name = "maDV"  type="text" class="form-control"
			placeholder="Nhập mã dịch vụ (DVxxx) x: là ký tự số"  onkeyup="validateMaDV()" />
	 	<p id="errorMaDV"  style="color: red"></p>
	</div>
	
	<div class="form-group">
		<form:label path="tenDV">Tên Dịch Vụ <span style="color: red;"> *</span></form:label>
		<form:input path="tenDV" id = "tenDV" name = "tenDV"  type="text" class="form-control" 
	...
	<div class="form-group">
		...
		<form:input path="donGia" id = "donGia" name = "donGia"  type="number" class="form-control"
			placeholder="Nhập Đơn Giá" onkeyup = "validateNumber('donGia','errorDonGia')"/>
